...
function showThankYouModal() {
  ...
  // Load Contact Us page content into the modal
  fetch('popup.html')  // Assuming you have a contact-us.html file
...
// Example function to trigger the modal when a pet is adopted
function adoptPet() {
  // Logic for adopting a pet (e.g., form submission)
  
  // After adopting, show the modal
  showThankYouModal();
}
